...
const Stats = ({ ipAddress, location, timezone, isp }) => {
  return (
    <div className="w-4/5 rounded -lg absolute top-52 md:top-56 left-10 md:left-40 bg-white z-10 flex flex-col md:flex-row container gap-4 md:gap-10 p-4 md:p-8 mt-2">
